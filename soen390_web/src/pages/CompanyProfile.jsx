...
export default function CompanyProfilePage(props) {
  ...
  return (
    <div className="CompanyProfileContainer">
      <CompanyHeader name={companyData.name} picture={companyData.picture} userId={userData.userID} companyId={companyId} isFollowing={isFollowingState} setIsFollowing={setIsFollowingState} userData={userData}></CompanyHeader>
