...
export async function createApplication(ownerID, email, firstName, lastName, phone,
    ...
    export async function getLastApplication(userID) {
        try {
          const response = await axios.get(api.BACKEND_API + "/application/getLastApplication/" + userID);
